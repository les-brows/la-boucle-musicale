...
var CAMERA_SPEED_INTIAL = 1
var CAMERA_SPEED = CAMERA_SPEED_INTIAL
var CAMERA_SPEED_INCREMENT = 0.15
var LEVEL_SIZE = 5000
...
const BULLET_SPREAD_MAX_LEVEL = 3
...
var NB_BULLET_PLAYER: int = 1
var MELODY_LEVEL: int = 0
